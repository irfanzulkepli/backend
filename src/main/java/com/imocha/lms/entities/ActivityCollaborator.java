...
public class ActivityCollaborator implements Serializable {
     ...
     */
    public class ActivityCollaboratorId implements Serializable {
     ...
     * @return True if other object is instance of class ActivityCollaborator and the key objects are equal
     */
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ActivityCollaborator)) return false;
