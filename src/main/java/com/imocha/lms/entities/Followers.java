...
@Entity
@Table(name="followers", indexes={@Index(name="followersFollowersContextableTypeContextableIdIndex", columnList="contextable_type,contextable_id")})
public class Followers implements Serializable {
     ...
     * @return True if other object is instance of class Followers and the key objects are equal
     */
    ...
    public boolean equals(Object other) {
        if (!(other instanceof Followers)) return false;
