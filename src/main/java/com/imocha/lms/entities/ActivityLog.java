...
@Entity
@Table(name="activity_log", indexes={@Index(name="activityLogCauser", columnList="causer_id,causer_type"), @Index(name="activityLogSubject", columnList="subject_id,subject_type")})
public class ActivityLog implements Serializable {
     ...
     * @return True if other object is instance of class ActivityLog and the key objects are equal
     */
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ActivityLog)) return false;
