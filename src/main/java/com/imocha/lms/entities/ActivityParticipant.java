...
public class ActivityParticipant implements Serializable {
    ...
    /**
     * Gets the key fragment id for member activities.
     * If this.activities is null, a temporary stored value for the key
     * fragment will be returned. The temporary value is set by setActivitiesId.
    ...
    /**
     * Sets the key fragment id from member activities.
     * If this.activities is null, the passed value will be temporary
     * stored, and returned by subsequent calls to getActivitiesId.
    ...
    /**
     * Gets the key fragment id for member people.
     * If this.people is null, a temporary stored value for the key
     * fragment will be returned. The temporary value is set by setPeopleId.
     * This behavior is required by some persistence libraries to allow
     * fetching of objects in arbitrary order.
     *
     * @return Current (or temporary) value of the key fragment
    ...
    /**
     * Sets the key fragment id from member people.
     * If this.people is null, the passed value will be temporary
     * stored, and returned by subsequent calls to getPeopleId.
     * This behaviour is required by some persistence libraries to allow
     * fetching of objects in arbitrary order.
     *
     * @param aId New value for the key fragment
     ...
     * @return True if other object is instance of class ActivityParticipant and the key objects are equal
     */
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ActivityParticipant)) return false;
